...
// Generate static params for all professional-standards pages
export async function generateStaticParams() {
  return programmaticPages
    .filter(page => page.category === 'professional-standards' && page.status === 'published')
    .map(page => ({
      slug: page.slug
    }))
}
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const page = getPageBySlug('professional-standards', params.slug)
  ...
  return {
    ...
    openGraph: {
      ...
      description: page.metaDescription,
      type: 'article',
      url: `https://bitcoinestatecommission.org/professional-standards/${page.slug}`,
    },
    twitter: {
...
export default async function ProfessionalStandardsPage({ params }: PageProps) {
  const page = getPageBySlug('professional-standards', params.slug)
