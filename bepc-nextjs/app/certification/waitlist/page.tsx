...
export const metadata: Metadata = {
  ...
  description: 'Be among the first to access the comprehensive Bitcoin Estate Planning Certification when it launches in 2025. Early bird pricing available.',
